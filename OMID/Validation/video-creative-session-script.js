...
var module$exports$omid$common$version = {ApiVersion:"1.0", Version:"1.5.6-dev"};
...
function module$contents$omid$creatives$OmidVideoCreativeSession_convertVerificationScriptResources_(a) {
  return a.map(function(b) {
    return new module$exports$omid$sessionClient$VerificationScriptResource(b.resourceUrl, b.vendorKey, b.verificationParameters);
  });
}
var module$exports$omid$creatives$OmidVideoCreativeSession = function(a) {
  var b = new module$exports$omid$sessionClient$Partner("TestApp", "1.0");
  a = new module$exports$omid$sessionClient$Context(b, module$contents$omid$creatives$OmidVideoCreativeSession_convertVerificationScriptResources_(a), "testcontenturl.com", "test-custom-reference-data");
  this.adClient_ = new module$exports$omid$sessionClient$AdSession(a);
  if (!(this.adClient_ && this.adClient_.isSupported && this.adClient_.isSupported())) {
    throw Error("adSession not present");
  }
  this.player = document.getElementById("player");
  if (null == this.player) {
    throw Error("Player not present");
  }
  this.adEvents_ = new module$exports$omid$sessionClient$AdEvents(this.adClient_);
  this.mediaEvents = new module$exports$omid$sessionClient$MediaEvents(this.adClient_);
  this.sessionFinished_ = this.sessionActive_ = !1;
  this.lastVideoPercentage = null;
  this.isBuffering = this.shouldCallImpressionOccurredAndStart = !1;
  this.isFullscreen = document.fullscreenElement === this.player;
  this.quartileEvents = {"1q":!1, "2q":!1, "3q":!1, "4q":!1};
};
module$exports$omid$creatives$OmidVideoCreativeSession.main = function(a, b) {
  a = new module$exports$omid$creatives$OmidVideoCreativeSession(a);
  a.start();
  return a;
};
module$exports$omid$creatives$OmidVideoCreativeSession.prototype.start = function() {
  var a = this;
  this.setupEventListeners_();
  this.adClient_.registerSessionObserver(function(b) {
    return a.onSessionEvent_(b);
  });
};
module$exports$omid$creatives$OmidVideoCreativeSession.prototype.onSessionEvent_ = function(a) {
  switch(a.type) {
    case module$exports$omid$common$constants.AdEventType.SESSION_START:
      this.sessionActive_ = !0;
      this.shouldCallImpressionOccurredAndStart && this.callImpressionOccurredAndVideoStart();
      break;
    case module$exports$omid$common$constants.AdEventType.SESSION_FINISH:
      this.sessionActive_ = !1, this.sessionFinished_ = !0;
  }
};
module$exports$omid$creatives$OmidVideoCreativeSession.prototype.setupEventListeners_ = function() {
  var a = this;
  this.player.addEventListener("play", function() {
    a.sessionFinished_ || 0 != a.player.currentTime && a.mediaEvents.resume();
  });
  this.player.addEventListener("pause", function() {
    a.sessionFinished_ || a.player.ended || a.mediaEvents.pause();
  });
  this.player.addEventListener("waiting", function() {
    a.sessionFinished_ || (a.isBuffering = !0, a.mediaEvents.bufferStart());
  });
  this.player.addEventListener("timeupdate", function() {
    if (!a.sessionFinished_ && (a.isBuffering && (a.isBuffering = !1, a.mediaEvents.bufferFinish()), 0 < a.player.duration)) {
      var b = a.player.currentTime / a.player.duration;
      0 <= b && null == a.lastVideoPercentage ? a.callImpressionOccurredAndVideoStart() : .25 <= b && !a.quartileEvents["1q"] ? (a.quartileEvents["1q"] = !0, a.mediaEvents.firstQuartile()) : .50 <= b && !a.quartileEvents["2q"] ? (a.quartileEvents["2q"] = !0, a.mediaEvents.midpoint()) : .75 <= b && !a.quartileEvents["3q"] ? (a.quartileEvents["3q"] = !0, a.mediaEvents.thirdQuartile()) : .99 <= b && !a.quartileEvents["4q"] && (a.quartileEvents["4q"] = !0, a.mediaEvents.complete());
      a.lastVideoPercentage = b;
    }
  });
  this.player.addEventListener("volumechange", function() {
    a.sessionFinished_ || a.mediaEvents.volumeChange(a.player.muted ? 0 : a.player.volume);
  });
  this.player.addEventListener("webkitendfullscreen", function() {
    a.sessionFinished_ || a.mediaEvents.playerStateChange(module$exports$omid$common$constants.VideoPlayerState.NORMAL);
  });
  this.player.addEventListener("webkitbeginfullscreen", function() {
    a.sessionFinished_ || a.mediaEvents.playerStateChange(module$exports$omid$common$constants.VideoPlayerState.FULLSCREEN);
  });
  this.player.onfullscreenchange = function(b) {
    a.sessionFinished_ || (console.log("fullscreen change"), document.fullscreenElement ? a.mediaEvents.playerStateChange(module$exports$omid$common$constants.VideoPlayerState.FULLSCREEN) : a.mediaEvents.playerStateChange(module$exports$omid$common$constants.VideoPlayerState.NORMAL));
  };
};
module$exports$omid$creatives$OmidVideoCreativeSession.prototype.startSession = function() {
  this.adClient_.start();
};
module$exports$omid$creatives$OmidVideoCreativeSession.prototype.finishSession = function() {
  this.adClient_.finish();
};
module$exports$omid$creatives$OmidVideoCreativeSession.prototype.setCreativeType = function(a) {
  this.adClient_.setCreativeType(a);
};
module$exports$omid$creatives$OmidVideoCreativeSession.prototype.setImpressionType = function(a) {
  this.adClient_.setImpressionType(a);
};
module$exports$omid$creatives$OmidVideoCreativeSession.prototype.loaded = function() {
  var a = new module$exports$omid$common$VastProperties(!1, 0, !0, module$exports$omid$common$constants.VideoPosition.STANDALONE);
  this.adEvents_.loaded(a);
};
module$exports$omid$creatives$OmidVideoCreativeSession.prototype.impressionOccurredAndVideoStart = function() {
  this.sessionActive_ ? (this.adEvents_.impressionOccurred(), this.mediaEvents.start(this.player.duration, this.player.muted ? 0 : this.player.volume)) : this.shouldCallImpressionOccurredAndStart = !0;
};
module$exports$omid$creatives$OmidVideoCreativeSession.prototype.callImpressionOccurredAndVideoStart = function() {
  this.impressionOccurredAndVideoStart();
  this.shouldCallImpressionOccurredAndStart = !1;
};
var module$exports$omid$creatives$OmidVideoCreativeSessionMain = {}, module$contents$omid$creatives$OmidVideoCreativeSessionMain_omidSession = module$exports$omid$creatives$OmidVideoCreativeSession.main([{resourceUrl:"[INSERT RESOURCE URL]", vendorKey:"iabtechlab.com-omid", verificationParameters:""}, {resourceUrl:"https://s3-us-west-2.amazonaws.com/omsdk-files/js/verification-measurement-script.js", vendorKey:null, verificationParameters:null}]);
module$contents$omid$creatives$OmidVideoCreativeSessionMain_omidSession.setCreativeType("video");
module$contents$omid$creatives$OmidVideoCreativeSessionMain_omidSession.setImpressionType("loaded");
module$contents$omid$creatives$OmidVideoCreativeSessionMain_omidSession.loaded();
