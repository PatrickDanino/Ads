...
function module$contents$omid$creatives$OmidCreativeSession_convertVerificationScriptResources_(a) {
...
var module$exports$omid$creatives$OmidCreativeSession = function(a) {
  var b = new module$exports$omid$sessionClient$Partner("TestApp", "1.0");
  a = new module$exports$omid$sessionClient$Context(b, module$contents$omid$creatives$OmidCreativeSession_convertVerificationScriptResources_(a));
  ...
  this.shouldCallImpressionOccurred_ = this.sessionActive_ = !1;
};
module$exports$omid$creatives$OmidCreativeSession.main = function(a, b) {
  a = new module$exports$omid$creatives$OmidCreativeSession(a);
  a.start();
  return a;
};
module$exports$omid$creatives$OmidCreativeSession.prototype.start = function() {
  var a = this;
  this.adClient_.registerSessionObserver(function(b) {
    return a.onSessionEvent_(b);
  });
};
module$exports$omid$creatives$OmidCreativeSession.prototype.onSessionEvent_ = function(a) {
  switch(a.type) {
    case module$exports$omid$common$constants.AdEventType.SESSION_START:
      this.sessionActive_ = !0;
      this.shouldCallImpressionOccurred_ && this.callImpressionOccurred_();
      break;
    case module$exports$omid$common$constants.AdEventType.SESSION_FINISH:
      this.sessionActive_ = !1;
  }
};
module$exports$omid$creatives$OmidCreativeSession.prototype.setCreativeType = function(a) {
  this.adClient_.setCreativeType(a);
};
module$exports$omid$creatives$OmidCreativeSession.prototype.setImpressionType = function(a) {
  this.adClient_.setImpressionType(a);
};
module$exports$omid$creatives$OmidCreativeSession.prototype.loaded = function() {
  this.adEvents_.loaded();
};
module$exports$omid$creatives$OmidCreativeSession.prototype.impressionOccurred = function() {
  this.sessionActive_ ? this.callImpressionOccurred_() : this.shouldCallImpressionOccurred_ = !0;
};
module$exports$omid$creatives$OmidCreativeSession.prototype.callImpressionOccurred_ = function() {
  this.adEvents_.impressionOccurred();
  this.shouldCallImpressionOccurred_ = !1;
};
var module$exports$omid$creatives$OmidCreativeSessionMain = {}, module$contents$omid$creatives$OmidCreativeSessionMain_omidSession = module$exports$omid$creatives$OmidCreativeSession.main([{resourceUrl:"[INSERT RESOURCE URL]", vendorKey:"ignored", verificationParameters:"ignored"}, {resourceUrl:"https://s3-us-west-2.amazonaws.com/omsdk-files/js/verification-measurement-script.js", vendorKey:null, verificationParameters:null}]);
module$contents$omid$creatives$OmidCreativeSessionMain_omidSession.setCreativeType("htmlDisplay");
module$contents$omid$creatives$OmidCreativeSessionMain_omidSession.setImpressionType("loaded");
module$contents$omid$creatives$OmidCreativeSessionMain_omidSession.loaded();
module$contents$omid$creatives$OmidCreativeSessionMain_omidSession.impressionOccurred();
