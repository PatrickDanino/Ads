...
var module$exports$omid$creatives$VisibilityMeasurementClient = function(a) {
  this.verificationClient_ = a;
  this.verificationClient_.isSupported() || console.log("Omid was not available for client to call");
...
module$exports$omid$creatives$VisibilityMeasurementClient.prototype.handleSessionObserverEvent_ = function(a) {
  a.type === module$exports$omid$common$constants.AdEventType.SESSION_START && (window.top.document.getElementById("omidId").innerText = a.adSessionId);
};
module$exports$omid$creatives$VisibilityMeasurementClient.prototype.handleGeometryChangeEvent_ = function(a) {
  console.log("handleGeometryChangeEvent, percentageInView = [" + a.data.adView.percentageInView + "]");
  a = a.data.adView.percentageInView;
  window.top.document.getElementById("percentageInView").innerText = a + "%";
  window.top.document.body.style.backgroundColor = this.setBackgroundColor_(a);
};
module$exports$omid$creatives$VisibilityMeasurementClient.prototype.setBackgroundColor_ = function(a) {
  return 75 <= a ? "Green" : 50 <= a ? "PaleGreen" : 25 <= a ? "PaleVioletRed" : "Red";
};
var module$exports$omid$creatives$VisibilityMeasurementClientMain = {};
new module$exports$omid$creatives$VisibilityMeasurementClient(new module$exports$omid$verificationClient$VerificationClient());
